...
import com.example.viewmodelex.ui.theme.ViewModelExTheme
...
fun MainScreen(
    ...
    Column(
        ...
        Text("Temperature Converter", modifier = Modifier.padding(20.dp), style = MaterialTheme.typography.headlineSmall)
